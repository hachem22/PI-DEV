 ...
 */
final class Version20250211101344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dossier_medical (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, groupe_sanguin VARCHAR(255) NOT NULL, allergies LONGTEXT NOT NULL, vaccinations LONGTEXT NOT NULL, antecedents_medicaux LONGTEXT DEFAULT NULL, traitements_en_cours LONGTEXT DEFAULT NULL, remarques LONGTEXT DEFAULT NULL, INDEX IDX_3581EE626B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, medecin_id INT NOT NULL, service_id INT NOT NULL, date DATE NOT NULL, heure TIME NOT NULL, rendez_vous_status VARCHAR(50) DEFAULT NULL, INDEX IDX_65E8AA0A4F31A84 (medecin_id), INDEX IDX_65E8AA0AED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
