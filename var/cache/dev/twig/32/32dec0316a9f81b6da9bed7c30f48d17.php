...
class __TwigTemplate_16700ef1b194bd0cb7ad9a781d456ce1 extends Template
{
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lit"]) {
            ...
            // line 250
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("lit.delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["lit"], "id", [], "any", false, false, false, 250)]), "html", null, true);
            ...
            new Chart(chambresCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [";
        // line 322
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["chambresDisponibles"]) || array_key_exists("chambresDisponibles", $context) ? $context["chambresDisponibles"] : (function () { throw new RuntimeError('Variable "chambresDisponibles" does not exist.', 322, $this->source); })()), "html", null, true);
        yield ", ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["chambresOccupees"]) || array_key_exists("chambresOccupees", $context) ? $context["chambresOccupees"] : (function () { throw new RuntimeError('Variable "chambresOccupees" does not exist.', 322, $this->source); })()), "html", null, true);
        yield ", ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["chambresMaintenance"]) || array_key_exists("chambresMaintenance", $context) ? $context["chambresMaintenance"] : (function () { throw new RuntimeError('Variable "chambresMaintenance" does not exist.', 322, $this->source); })()), "html", null, true);
        yield "],
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: { display: true, text: 'Statut des Chambres' }
                    }
                }
            });

            const litsCtx = document.getElementById('litsChart').getContext('2d');
            new Chart(litsCtx, {
                type: 'bar',
                data: {
                    labels: ['Lits Occupés', 'Lits Disponibles'],
                    datasets: [{
                        label: 'Nombre de lits',
                        data: [";
        // line 342
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["litsOccupes"]) || array_key_exists("litsOccupes", $context) ? $context["litsOccupes"] : (function () { throw new RuntimeError('Variable "litsOccupes" does not exist.', 342, $this->source); })()), "html", null, true);
        yield ", ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["litsDisponibles"]) || array_key_exists("litsDisponibles", $context) ? $context["litsDisponibles"] : (function () { throw new RuntimeError('Variable "litsDisponibles" does not exist.', 342, $this->source); })()), "html", null, true);
        yield "],
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: { display: true, text: 'Statut des Lits' }
                    },
                    scales: {
                        y: { beginAtZero: true }
                    }
...
";
    ...
    {
        return array (  541 => 342,  514 => 322,  452 => 262,  443 => 258,  441 => 261,  429 => 250,  423 => 247,  420 => 246,  412 => 242,  410 => 241,  407 => 240,  399 => 238,  395 => 236,  393 => 235,  388 => 233,  384 => 232,  379 => 229,  374 => 228,  364 => 221,  358 => 218,  338 => 201,  318 => 184,  314 => 183,  293 => 165,  273 => 148,  269 => 147,  247 => 127,  234 => 126,  221 => 122,  208 => 121,  84 => 7,  78 => 3,  65 => 2,  42 => 1,);
    }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            new Chart(chambresCtx, {
                ...
                data: {
                    labels: ['Disponibles', 'Occupées', 'Maintenance'],
                    datasets: [{
                        data: [{{ chambresDisponibles }}, {{ chambresOccupees }}, {{ chambresMaintenance }}],
                        backgroundColor: ['#4caf50', '#f44336', '#ff9800'],
                    }]
                },
                options: {
            ...
            new Chart(litsCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Nombre de lits',
                        data: [{{ litsOccupes }}, {{ litsDisponibles }}],
                        backgroundColor: ['#f44336', '#4caf50'],
                    }]
                },
                options: {
