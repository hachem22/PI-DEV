...
class __TwigTemplate_e0ce20dc4038dd3464b5364aebde940a extends Template
{
...
<p>
    <a href=\"";
        // line 7
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reset_password", ["token" => (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 7, $this->source); })())])), "html", null, true);
        yield "\">
        Reset Password
    </a>
</p>
...
<p>You have requested to reset your password. Click the link below to reset it:</p>
<p>
    <a href=\"{{ absolute_url(path('app_reset_password', {'token': resetToken})) }}\">
        Reset Password
    </a>
</p>
<p>This link will expire in 1 hour.</p>", "emails/reset_password.html.twig", "C:\\Users\\aziz\\Desktop\\pidevhaythemv3\\pidevHaythemv2\\pidevHaythem\\Nouveau dossier (2)\\PI-DEV\\templates\\emails\\reset_password.html.twig");
    }
}
