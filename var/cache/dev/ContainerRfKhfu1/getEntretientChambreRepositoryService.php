 ...
 */
class getEntretientChambreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntretientChambreRepository' shared autowired service.
     *
     * @return \App\Repository\EntretientChambreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntretientChambreRepository.php';

        return $container->privates['App\\Repository\\EntretientChambreRepository'] = new \App\Repository\EntretientChambreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
