 ...
 */
class getDefault_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'default.middleware.send_message' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['default.middleware.send_message'])) {
            return $container->privates['default.middleware.send_message'];
        }
        ...
        $container->privates['default.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Message\\UserCreationEmailMessage' => ['async']], $a), $b, true);
